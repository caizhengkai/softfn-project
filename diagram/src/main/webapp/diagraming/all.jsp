...
<head>
    ...
    <title>Sample Organization Template - ProcessOn</title>
    ...
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/basic.js?1385350374'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/flow.js?1384420198'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/bpmn.js?1384420173'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/evc.js?1384420187'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/epc.js?1384420180'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/lane.js?1384420201'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/er.js?1384420183'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_common.js?1384420214'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_usecase.js?1384420231'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_sequence.js?1384420224'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_class.js?1384420210'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_stateactivity.js?1384420227'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_deployment.js?1384420220'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/uml_component.js?1384420217'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/ui.js?1385709967'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/ui_input.js?1385608011'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/org.js?1384420205'></script>
    <script type='text/javascript' charset='UTF-8'
            src='/scripts_bin/zh/diagraming/schema/categories/venn.js?1385549422'></script>
    <script type="text/javascript">
        var chartId = "52b13f440cf232c3edefc5b2";

        var definition = {"elements": {}, "page": {"backgroundColor": "255,255,255", "gridSize": 15, "height": 1485, "padding": 60, "showGrid": true, "width": 1050}}


        var role = "owner";
        var userId = "521dcb690cf20afe916bb48f";
        var userName = "softfn";
        var time = "1387348839348";
    </script>
    <script type='text/javascript' charset='UTF-8'
...
<div id="designer_header">
    <div class="titlebar">
        <a class="btn_back" href="/diagraming/back?id=52b13f440cf232c3edefc5b2" title='返回'><span
                class="ico ico_goback"></span></a>

        <div class="row row1">
            <div id="title_container">
                <span class="diagram_title">Sample Organization Template</span>
            </div>
        </div>
    ...
    <div class="toolbar">
        ...
        <a id="bar_return" class="toolbar_button" href="/diagraming/back?id=52b13f440cf232c3edefc5b2" title='返回'><span
                class="ico ico_goback"></span></a>
    </div>
</div>
<div id="designer">
...
<div id="export_dialog" class="dialog" style="min-width: 450px;">
    ...
    <div class="dialog_content">
        <form id="export_form" action="/diagram_export" method="post">
            ...
            <input type="hidden" name="chartId" value="52b13f440cf232c3edefc5b2"/>
...
<div id="disconnected" class="dialog">
    ...
    <div class="dialog_buttons">
        <a class="designer_button" href="/diagraming/52b13f440cf232c3edefc5b2">重试</a>&nbsp;
        <a class="designer_button normal" href="/diagraming/back?id=52b13f440cf232c3edefc5b2">关闭</a>
    </div>
</div>
